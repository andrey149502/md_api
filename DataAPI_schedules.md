...
* [Создание графика активности](#Создание-графика-активности)
	...
	- [Параметры ответа](#Параметры-ответа-1)
	- [JSON структура запроса](#json-структура-запроса-1)
	- [JSON структура ответа](#json-структура-ответа-1)
	- [Список возвращаемых ошибок](#Список-возвращаемых-ошибок-1)
* [Удаление графика активности](#Удаление-графика-активности)
	- [Параметры запроса](#Параметры-запроса-2)
	- [JSON структура запроса](#json-структура-запроса-2)
	- [Параметры ответа](#Параметры-ответа-2)
	- [Список возвращаемых ошибок](#Список-возвращаемых-ошибок-2)
* [Редактирование графика активности](#Редактирование-графика-активности)
	- [Параметры запроса](#Параметры-запроса-3)
	- [JSON структура запроса](#json-структура-запроса-3)
	- [JSON структура ответа](#json-структура-ответа-3)
	- [Список возвращаемых ошибок](#Список-возвращаемых-ошибок-3)
